...
<div class="menu">
    ...
    <?php
        if(isset($_GET["acc"])){
            if($_GET["acc"] == 1){
                echo '<div class="mensaje"><p style="color:green">Amigo insertado correctamente</p></div>';
                header("refresh: 2; url= ../controlador/index.php?action=amigos");
            }
            if($_GET["acc"] == 2){
                echo '<div class="mensaje"><p style="color:green">Amigo modificado correctamente</p></div>';
                header("refresh: 2; url= ../controlador/index.php?action=amigos");
            }
        }
        if(isset($_GET["err"])){
